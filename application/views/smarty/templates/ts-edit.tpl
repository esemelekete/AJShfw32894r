				...
				<div class="card-body text-body">
					{form_open(null, 'enctype="multipart/form-data"')}
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="date" name="tgl_kadaluarsa_sk_ban_pt" value="{set_value('tgl_kadaluarsa_sk_ban_pt')|default:$identitas->tgl_kadaluarsa_sk_ban_pt}" class="form-control {if form_error('tgl_kadaluarsa_sk_ban_pt')}is-invalid{/if}">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="unit_pengelola" value="{set_value('unit_pengelola')|default:$identitas->unit_pengelola}" class="form-control {if form_error('unit_pengelola')}is-invalid{/if}">
						...
						<div class="form-group">
							...
							<textarea name="alamat" class="form-control {if form_error('alamat')}is-invalid{/if}">{set_value('alamat')|default:$identitas->alamat}</textarea>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="telepon" value="{set_value('telepon')|default:$identitas->telepon}" class="form-control {if form_error('telepon')}is-invalid{/if}">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="email" value="{set_value('email')|default:$identitas->email}" class="form-control {if form_error('email')}is-invalid{/if}">
									{if form_error('email')}
										<small class="text-danger">
											{form_error('email')}
										</small>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="website" value="{set_value('website')|default:$identitas->website}" class="form-control {if form_error('website')} is-invalid {/if}">
