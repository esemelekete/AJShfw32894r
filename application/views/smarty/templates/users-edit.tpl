...
{assign var="title" value="Edit Pengguna"}
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="first_name" value="{set_value('first_name')|default:$user->first_name}" class="form-control {if form_error('first_name')}is-invalid{/if}">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="last_name" value="{set_value('last_name')|default:$user->last_name}" class="form-control {if form_error('last_name')}is-invalid{/if}">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="phone" value="{set_value('phone')|default:$user->phone}" class="form-control {if form_error('phone')}is-invalid{/if}">
									{if form_error('phone')}
								...
								<div class="form-group">
									...
									<select name="group" id="group" class="form-control">
										...
										{foreach from=$this->db->get('groups')->result() item=$group}
											<option value="{$group->id}" {if $selected_group === $group->id}selected{/if}>
												{if $group->name === 'admin'}
													Admin
												{else}
													Umum
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="email" value="{set_value('email')|default:$user->email}" class="form-control {if form_error('email')}is-invalid{/if}">
									{if form_error('email')}
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<select name="id_standar" id="id_standar" class="form-control {if form_error('id_standar')}is-invalid{/if}">
										...
										{foreach from=$this->db->get('standar')->result() item=$standar}
											<option value="{$standar->id}" {if $selected_standar === $standar->id}selected{/if}>
												{$standar->nama}
											</option>
										{/foreach}
									</select>
