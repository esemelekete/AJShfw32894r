						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="first_name" value="{set_value('first_name')|default:$user->first_name}" class="form-control {if form_error('first_name')}is-invalid{/if}" autocomplete="off">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="last_name" value="{set_value('last_name')|default:$user->last_name}" class="form-control {if form_error('last_name')}is-invalid{/if}" autocomplete="off">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="phone" value="{set_value('phone')|default:$user->phone}" class="form-control {if form_error('phone')}is-invalid{/if}" autocomplete="off">
									{if form_error('phone')}
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="email" value="{set_value('email')|default:$user->email}" class="form-control {if form_error('email')}is-invalid{/if}" autocomplete="off">
									{if form_error('email')}
								...
								<div class="form-group">
									...
									<select name="id_kriteria" id="id_kriteria" class="form-control {if form_error('id_kriteria')}is-invalid{/if}">
										...
										{foreach from=$this->db->get('kriteria')->result() item=$kriteria}
											<option value="{$kriteria->id}" {if $selected_kriteria === $kriteria->id}selected{/if}>
												{$kriteria->nama}
											</option>
										{/foreach}
									</select>
